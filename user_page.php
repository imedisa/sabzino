  ...
  <body>
    ...
    <header class="l-header" id="header">
      <nav class="nav bd-container">
        ...
        <p>خوش امدید <?php echo isset($_SESSION['user_name']) ? htmlspecialchars($_SESSION['user_name']) : 'Guest'; ?>
        </p>
        </div>
      </nav>
    </header>
    ...
    <main class="l-main">
      ...
      >
        ...
        <div>
          <form action="bmi_user.php" method="post" class="border border-green-600 p-7 rounded-lg">
        ...
        <div>
          <form action="fat_user.php" method="post" class="border border-green-600 p-7 rounded-lg">
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <!-- <div>
                <input
                  name="user_weight"
              ...
              <div>
                <input
                  ...
                  class="border border-green-600 w-full rounded-lg p-3"
                  type="number"
                  placeholder="دور کمر شما:"
                />
              </div>
              <button class="button flex justify-center !items-center" type="submit">محاسبه درصد چربی</button>
